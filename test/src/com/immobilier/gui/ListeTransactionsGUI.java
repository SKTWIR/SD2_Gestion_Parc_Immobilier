...
public class ListeTransactionsGUI {
    public void display() {
        ...
        ajouterButton.addActionListener(e -> new FormulaireAjoutTransactions().display());
        ...
        supprimerButton.addActionListener(e -> {
            ...
            if (selectedRow != -1) {
                String codeTransaction = model.getValueAt(selectedRow, 0).toString();
                model.removeRow(selectedRow);
                updateCSV("transactions.csv", codeTransaction);
                JOptionPane.showMessageDialog(frame, "Transaction supprimée avec succès.");
            } else {
