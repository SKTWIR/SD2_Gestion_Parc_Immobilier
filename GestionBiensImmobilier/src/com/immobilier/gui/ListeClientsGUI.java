...
public class ListeClientsGUI {
    public void display() {
        ...
        String[] columns = {"Code Client", "Nom", "Téléphone", "Email", "Type"};
        ...
        supprimerButton.addActionListener(e -> {
            ...
            if (selectedRow != -1) {
                String codeClient = model.getValueAt(selectedRow, 0).toString();
                model.removeRow(selectedRow);
                updateCSV("clients.csv", codeClient);
